...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="ClientPage.jsp">Flock.lk</a>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Client Home Page</li>
      </ol>
      <div class="row">
          
        <div class="col-12">
            <div id="content-wrapper">
                 <form action="../StockUpdate" >
                <img src="../css/images/c394231f-f5be-a473-127d-dbb8df3bc368.jpg" height="270px" width="270px">
             
                <input class="button1" type="submit" value="BUY" />
              </form>
            </div>
        </div>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a class="btn btn-primary" href="../ClientLogout">Logout</a>
          </div>
        </div>
      </div>
    </div>
